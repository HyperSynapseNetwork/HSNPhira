export const messages = {
  zh: {
    ...
    about: {
      ...
      feedback: '问题反馈',
      feedbackText: '您可以前往我们的Github页面提交Issue，加入我们的QQ群1049578201，或者向FireflyF09@outlook.com反馈您的问题与建议。',
  ...
  en: {
    ...
    about: {
      ...
      feedback: 'Feedback',
      feedbackText: 'You can submit issues on our GitHub page, join our QQ group 1049578201, or send feedback and suggestions to FireflyF09@outlook.com.',
      githubIssues: 'GitHub Issues',
      qqGroup: 'QQ Group',
      donate: 'Donate',
    ...
    announcement: {
      ...
      frontendReleaseTitle: 'HSNPhira Frontend v1.0.2 Released',
      frontendReleaseContent: 'Fixed numerous issues and optimized user experience.',
  ...
  ja: {
    ...
    about: {
      ...
      feedback: 'フィードバック',
      feedbackText: 'GitHubページでIssueを提出するか、QQグループ1049578201に参加するか、FireflyF09@outlook.comにフィードバックや提案を送信してください。',
      githubIssues: 'GitHub Issues',
      qqGroup: 'QQグループ',
      donate: '寄付',
    ...
    announcement: {
      ...
      frontendReleaseTitle: 'HSNPhira Frontend v1.0.2 リリース',
      frontendReleaseContent: '多数の問題を修正し、ユーザーエクスペリエンスを最適化しました。',
  ...
  'zh-TW': {
    ...
    about: {
      ...
      feedback: '問題反饋',
      feedbackText: '您可以前往我們的Github頁面提交Issue，加入我們的QQ群1049578201，或者向FireflyF09@outlook.com反饋您的問題與建議。',
      githubIssues: 'GitHub Issues',
      qqGroup: 'QQ群',
      donate: '捐助我們',
    ...
    announcement: {
      ...
      frontendReleaseTitle: 'HSNPhira Frontend v1.0.2 發佈',
      frontendReleaseContent: '修復了大量問題，優化了用戶體驗。',
